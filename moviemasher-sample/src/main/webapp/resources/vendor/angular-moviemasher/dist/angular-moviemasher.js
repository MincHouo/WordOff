...
(function(){
  ...
  var __default_config = {
    rest: {
      media: {
        search: {
          url: 'resources/vendor/angular-moviemasher/php/media.php?group=:group',
          params: {group: '@group'},
          method: 'get',
          isArray: true,
        },
      ...
      mash: {
        search: {
          url: 'resources/vendor/angular-moviemasher/php/media.php?group=mash',
          method: 'get',
          isArray: true,
        },
        data: {
          url: 'resources/vendor/angular-moviemasher/php/mash.php?id=:id',
          params: {id: '@id'},
          method: 'get',
        },
        save: {
          url: 'resources/vendor/angular-moviemasher/php/save.php?id=:id',
          params: {id: '@id'},
          method: 'post',
        },
      },
      import: {
        api: {
          url: 'resources/vendor/angular-moviemasher/php/import_api.php',
          method: 'post',
        },
        init: {
          url: 'resources/vendor/angular-moviemasher/php/import_init.php',
          method: 'post',
        },
        monitor: {
          url: 'resources/vendor/angular-moviemasher/php/import_monitor.php',
          method: 'post',
        },
      },
      export: {
        init: {
          url: 'resources/vendor/angular-moviemasher/php/export_init.php',
          method: 'post',
        },
        monitor: {
          url: 'resources/vendor/angular-moviemasher/php/export_monitor.php',
          method: 'post',
        },
      },
    }
